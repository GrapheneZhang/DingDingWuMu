!function (a) {
    ...
    var b, c = "function" == typeof define && define.amd, d = function (b) {
        ...
        var b = function (b) {
            ...
            if (0 === d)return b(c) ? null : {node: c.parentNode, offset: A(c)};
            if (B(c)) {
                var e = c.childNodes[d - 1];
                return{node: e, offset: y(e)}
            }
            ...
            return a = u(a.cloneNode(!1), a), v(a, r(c))
        }, G = function (a, b, c) {
            var d = n(b, f.eq(a));
            return 1 === d.length ? F(b, c) : d.reduce(function (a, d) {
                var e = d.cloneNode(!1);
                return u(e, d), a === b && (a = F(a, c)), v(e, r(a)), e
            })
        }, H = function (a, b) {
            if (a && a.parentNode) {
        ...
        return{blank: e.isMSIE ? "&nbsp;" : "<br/>", emptyPara: "<p><br/></p>", isEditable: b, isControlSizing: c, buildLayoutInfo: d, isText: w, isRootText: x, isPara: j, isList: k, isTable: i("TABLE"), isCell: l, isAnchor: i("A"), isDiv: i("DIV"), isLi: i("LI"), isSpan: i("SPAN"), isB: i("B"), isU: i("U"), isS: i("S"), isI: i("I"), isImg: i("IMG"), isTextarea: i("TEXTAREA"), length: y, isEdgeBP: z, prevBP: C, ancestor: m, listAncestor: n, listNext: r, listPrev: q, listDescendant: s, commonAncestor: o, listBetween: p, wrap: t, insertAfter: u, position: A, makeOffsetPath: D, fromOffsetPath: E, splitTree: G, remove: H, html: I}
    }(), i = {version: "0.5.3", options: {width: null, height: null, minHeight: null, maxHeight: null, focus: !1, tabsize: 4, styleWithSpan: !0, disableLinkTarget: !1, disableDragAndDrop: !1, disableResizeEditor: !1, codemirror: {mode: "text/html", htmlMode: !0, lineNumbers: !0, autoFormatOnStart: !1}, lang: "en-US", direction: null, toolbar: [
        ["style", ["style"]],
    ...
    }, nameFromCode: {8: "BACKSPACE", 9: "TAB", 13: "ENTER", 32: "SPACE", 48: "NUM0", 49: "NUM1", 50: "NUM2", 51: "NUM3", 52: "NUM4", 53: "NUM5", 54: "NUM6", 55: "NUM7", 56: "NUM8", 66: "B", 69: "E", 73: "I", 74: "J", 75: "K", 76: "L", 82: "R", 83: "S", 85: "U", 89: "Y", 90: "Z", 191: "SLASH", 219: "LEFTBRACKET", 220: "BACKSLASH", 221: "RIGHTBRACKET"}}, l = function () {
        var b = function (b, c) {
        ...
        var b = !!document.createRange, c = function (a, b) {
            ...
            this.isOnEditable = m(h.isEditable), this.isOnList = m(h.isList), this.isOnAnchor = m(h.isAnchor), this.isOnCell = m(h.isCell), this.isCollapsed = function () {
                ...
                return{s: {path: h.makeOffsetPath(a, c), offset: i}, e: {path: h.makeOffsetPath(a, j), offset: k}}
            }, this.getClientRects = function () {
                var a = l();
                return a.getClientRects()
            }
        };
        return{create: function (a, d, f, g) {
    ...
    var v = function () {
        var c = a(window), d = a(document), f = a("html, body"), i = new o, l = new r, m = new s, n = new t, q = new u, v = function (b) {
            ...
            }).trigger("resize"), f.css("overflow", "hidden")) : (c.off("resize"), i({w: h.width || "", h: e.data("orgheight")}), f.css("overflow", "visible")), l.updateFullscreen(d, j)
        }, codeview: function (a) {
            ...
            if (h.isControlSizing(b.target)) {
                ...
                d.on("mousemove",function (a) {
                    i.resizeTo({x: a.clientX - o.left, y: a.clientY - (o.top - p)}, l, !a.shiftKey), n.update(e, {image: k}, q), m.update(f, {image: k}, q)
